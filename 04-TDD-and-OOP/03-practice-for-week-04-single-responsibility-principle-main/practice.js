...
function findPieType(pieType) {
  return recipes[pieType];
}

function bakePieQuantity(recipe, pieQuantity, pieType) {
...
function totalRevenue(totalCost, profitMargin, pieQuantity) {
...
function bakeAndSellPies(pieType, pieQuantity, profitMargin) {
  ...
  const recipe = findPieType(pieType);
  // Bake the number of pies specified by the pieQuantity
  bakePieQuantity(recipe, pieQuantity, pieType);
  ...
  totalRevenue(totalCost,profitMargin, pieQuantity);
}
